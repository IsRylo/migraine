function predict({Age=0, Frequenc=0, Location=0, Character=0, Intensity=0, Photophobia=0, Visual=0, Sensory=0, Dysphasia=0, Vertigo=0, Tinnitus=0, Hypoacusis=0, Defect=0, DPF=0}) {
    if (Visual <= 0.5) {
        if (Sensory <= 0.5) {
            if (Intensity <= 2.5) {
...
function getClass({Age=0, Frequenc=0, Location=0, Character=0, Intensity=0, Photophobia=0, Visual=0, Sensory=0, Dysphasia=0, Vertigo=0, Tinnitus=0, Hypoacusis=0, Defect=0, DPF=0}) {
    ...
    result, certain = predict(Age, Frequency, Location, Character, Intensity, Photophobia, Visual, Sensory, Dysphasia, Vertigo, Tinnitus, Hypoacusis, Defect, DPF);
    migraine = classes[result.indexOf(Math.max(...result))]
